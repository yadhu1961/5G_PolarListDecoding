...
int main(int argc, char* argv[])
{
    ...
    uint8_t n = 2; //m in list decoding paper.
    uint16_t info_length = (uint16_t) (1 << (n - 1)); //rate half code.
    uint16_t crc_size = 0;
    ...
    double ebno_log_min = 4;
    double ebno_log_max = 4.1;
    double ebno_log_increment = 0.2;
